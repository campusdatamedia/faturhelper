            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.role.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_admin" id="is_admin-1" value="1" {{ $role->is_admin == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="is_admin-1">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_admin" id="is_admin-0" value="0" {{ $role->is_admin == '0' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_global" id="is_global-1" value="1" {{ $role->is_global == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="is_global-1">
                                    Global
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_global" id="is_global-0" value="0" {{ $role->is_global == '0' ? 'checked' : '' }}>
