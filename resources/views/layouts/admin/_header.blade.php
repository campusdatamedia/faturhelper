					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <img src="{{ Auth::user()->avatar != '' ? asset('assets/images/users/'.Auth::user()->avatar) : asset('assets/images/default/user.png') }}" class="avatar img-fluid rounded-circle me-1" alt="{{ Auth::user()->nama_user }}" /> <span class="text-dark">{{ Auth::user()->nama_user }}</span>
                            </a>
